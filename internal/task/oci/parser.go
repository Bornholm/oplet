...
// LabelParser handles parsing of Docker labels into task definitions
...
func (p *LabelParser) ParseLabels(labels map[string]string) (*ParsedLabels, error) {
	parsed := &ParsedLabels{
...
func (p *LabelParser) parseMetaLabels(labels map[string]string) MetaLabels {
	return MetaLabels{
...
func (p *LabelParser) parseInputLabels(labels map[string]string, parsed *ParsedLabels) error {
...
func (p *LabelParser) groupLabel(key, value, prefix string, groups map[string]map[string]string) error {
...
func (p *LabelParser) buildInputLabels(props map[string]string) (InputLabels, error) {
...
func (p *LabelParser) isValidInputType(inputType string) bool {
...
func (p *LabelParser) isValidValueType(valueType string) bool {
...
func (p *LabelParser) BuildTaskDefinition(parsed *ParsedLabels, imageRef string) (*task.Definition, error) {
...
func (p *LabelParser) convertToTaskInput(name string, inputLabels InputLabels) (*task.Input, error) {
